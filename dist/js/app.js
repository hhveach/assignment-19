...
var githubApiKey = exports.githubApiKey = '482bebf134849ff0cbad8f4e1516f9a41d58939f';
...
var contentBuild = function contentBuild(profInfo, repoInfo) {
...
var controllerRouter = function controllerRouter() {
  ...
  if (currentRoute === '') {
    var profilePromise = _jquery2.default.getJSON('https://api.github.com/users/hhveach');
    var reposPromise = _jquery2.default.getJSON('https://api.github.com/users/hhveach/repos');
    _jquery2.default.when(profilePromise, reposPromise).then(function (profileData, repoData) {
      injectContent.innerHTML = contentBuild(profileData[0], repoData[0]);
    });
    return;
  }

  var profilePromise = _jquery2.default.getJSON('https://api.github.com/users/' + ('' + currentRoute));
  var reposPromise = _jquery2.default.getJSON('https://api.github.com/users/' + ('' + currentRoute) + '/repos');
  _jquery2.default.when(profilePromise, reposPromise).then(function (profileData, repoData) {
    injectContent.innerHTML = contentBuild(profileData[0], repoData[0]);
  });
  return;
